...
const NotFound = () => {
  ...
  return (
    <section class="bg-white py-16 dark:bg-gray-900 ">
      ...
      <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
        <div class="w-full ">
          <div class="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center w-full mt-6 gap-3 sm:gap-x-3 sm:w-auto">

        <button    onClick={() => navigate(-1)} className="flex items-center justify-center w-full sm:w-auto px-5 py-3 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg dark:text-gray-200 gap-x-2 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-900 dark:border-gray-700">
          <svg
      ...
      <Link to="/">
        <button className="w-full sm:w-auto px-5 py-3 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
          Take me home
        </button>
      </Link>
    </div>
          ...
          <div class="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
            <div class="p-6 rounded-lg bg-blue-50 dark:bg-gray-800">
              ...
              <a href="#" class="inline-flex items-center mt-4 text-sm !text-blue-500 gap-x-2 dark:text-gray-200 hover:underline">
